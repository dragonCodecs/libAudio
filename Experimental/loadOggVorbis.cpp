...
bool OggVorbis_IsPlaying(void *p_VorbisFile)
{
	return ((OggVorbis_Intern *)p_VorbisFile)->p_Playback->IsPlaying();
}

bool OggVorbis_IsPaused(void *p_VorbisFile)
{
	return ((OggVorbis_Intern *)p_VorbisFile)->p_Playback->IsPaused();
}
